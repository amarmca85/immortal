    ...
    <link rel="stylesheet" href="stylesheet.css" type="text/css" charset="utf-8" />--%>
     <%--<% 
        Session["Session"] = "2017-2018";
           %>  --%>
   <script runat="server">
           //@Request.RequestContext.HttpContext.Session["Session"]=null;         
           string PType = "";
           string schlcode = "";
           string plot = "";
           string pclass = "";
           ...
           private string CommonCon = "myConn2017";
               ...
               {
                   {
                       ...
                       //                    +" on a.schl=b.schl where dist in (010,020,030,045,050,100,110,120,160,165,175) order by schl asc";


                       //0013194, 0024742
                       string qryregdate = "select  distinct top 500  a.schl,printlotnew as lot,a.class,[Type],Challandt,case when a.class='2' then 'Matric' else 'Senior' end as ClassName from exammasterregular2017 a inner join SchoolMaster b "
                                      +" on a.schl=b.schl where PrintStatus is null and  challanverify=1 and dist in (010,020,030,045,050,100,110,120,160,165,175) order by schl asc";
                       ...
                       if (objds != null && objds.Tables.Count > 0)
                       {
                           if (objds.Tables[0].Rows.Count > 0)
                           {
                               for (int t = 0; t < objds.Tables[0].Rows.Count; t++)
                               {
                                   ...
                                   // Local 
                                   // Filepath = "~/Upload/ExamPDF2017/" + schlcode + "_" + plot + "_" + pClassName + "_" + PType + ".pdf";
                                   // string FilepathExist = Path.Combine(Server.MapPath("~/Upload/ExamPDF2017"));
                                   // Server
                                   Filepath = AppPath + "/ExamPDF2017/" + schlcode + "_" + plot + "_" + pClassName + "_" + PType + ".pdf";
                                   string FilepathExist = AppPath + "/ExamPDF2017/";
                                   string saveFilePath = "Upload/ExamPDF2017/" + schlcode + "_" + plot + "_" + pClassName + "_" + PType + ".pdf";
           ...
           private byte[] RenderReport(string rptpath, DataSet ds2)
           {
               ...
               //else
               //{
               imagePath = new Uri(Server.MapPath("~/Upload/Upload2017/")).AbsoluteUri;
               //}
