...
// -->
    ...
    <script runat="server">
        ...
        {
            if (Session["SVFFormName"] == null || Session["SVFFormName"] == "")
            {
            ...
            {
                Form = Session["SVFFormName"].ToString();
        ...
        private void BindReport(string FormName,string SCHL)
        {
            try
            {
                ...
                //report path
                ReportViewerEmployee.LocalReport.ReportPath = Server.MapPath("~/RPTReports/RptStudentVerificationFormNew.rdlc");
        ...
        protected void btn_Download_Click(object sender, EventArgs e)
        {
            ...
            string fileName = "StudentVerificationForm" + SCHL + Form;
            //// ReportViewerEmployee.ProcessingMode = ProcessingMode.Local;     
...
<body>
    ...
    <div>
     ...
     <%-- <rsweb:ReportViewer ID="ReportViewerEmployee" runat="server" AsyncRendering="false" SizeToReportContent="true"
         ...
         <rsweb:ReportViewer Width="100%" ID="ReportViewerEmployee"
              SizeToReportContent="true" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">            
